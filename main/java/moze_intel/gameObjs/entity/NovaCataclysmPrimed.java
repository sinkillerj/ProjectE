...
public class NovaCataclysmPrimed extends EntityTNTPrimed
{
	public NovaCataclysmPrimed(World world) 
	{
		super(world);
		this.fuse = 20;
	}
	
	public NovaCataclysmPrimed(World world, double x, double y, double z, EntityLivingBase placer)
	{
