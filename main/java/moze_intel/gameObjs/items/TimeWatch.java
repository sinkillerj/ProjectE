...
public class TimeWatch extends ItemCharge implements IItemModeChanger
{
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int invSlot, boolean isHeld) 
	{
		...
		if (world.isRemote || !(entity instanceof EntityPlayer) || invSlot > 8 || stack.getItemDamage() == 0) return;
