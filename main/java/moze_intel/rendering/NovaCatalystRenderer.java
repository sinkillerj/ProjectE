...
public class NovaCatalystRenderer extends Render
{
    ...
    {
        this.doRender((NovaCatalystPrimed) entity, x, y, z, f1, f2);
    }

    public void doRender(NovaCatalystPrimed entity, double x, double y, double z, float par8, float par9)
    {
        GL11.glPushMatrix();
	...
	protected ResourceLocation getEntityTexture(NovaCatalystPrimed entity) 
	{
    ...
    {
        return this.getEntityTexture((NovaCatalystPrimed) entity);
    }
}
