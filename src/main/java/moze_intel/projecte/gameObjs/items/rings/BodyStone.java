...
public class BodyStone extends RingToggle implements ITTBaubleFunctionalityGroup, ITTPedestalFunctionalityGroupSpecial, ITTHotbarFunctionalityGroup, ITTConsumesEMC, ITTGeneralFunctionality
{
	public BodyStone()
	{
		super("body_stone");
