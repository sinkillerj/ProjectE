...
public class BodyStone extends RingToggle implements ITTBaubleFunctionality, ITTPedestalFunctionalitySpecial, ITTHotbarFunctionality, ITTConsumesEMC, ITTGeneralFunctionality
{
	public BodyStone()
	{
		super("body_stone");
	...
	{
		return Lists.newArrayList(StatCollector.translateToLocal("pe.body.general"));
	}
}
