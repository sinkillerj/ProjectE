...
public class LifeStone extends RingToggle implements ITTBaubleFunctionalityGroup, ITTPedestalFunctionalityGroupSpecial, ITTHotbarFunctionalityGroup, ITTGeneralFunctionality, ITTConsumesEMC
{
	public LifeStone()
	{
		super("life_stone");
