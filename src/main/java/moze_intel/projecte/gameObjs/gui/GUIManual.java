...
public class GUIManual extends GuiScreen {
	...
	public void drawScreen(int par1, int par2, float par3){		
	    ...
	    for(int i = 0; i < this.buttonList.size(); i++){
            if(i<3)((GuiButton) this.buttonList.get(i)).drawButton(this.mc, par1, par2);
            else if(this.currentPage == -1)((GuiButton) this.buttonList.get(i)).drawButton(this.mc, par1, par2);
        }
