...
public class GUIRelayMK2 extends GuiContainer
{
	...
	protected void drawGuiContainerForegroundLayer(int var1, int var2)
	{
		...
		this.fontRendererObj.drawString(Double.toString(tile.displayEmc), 107, 25, 4210752);
	}
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) 
	{
		...
		this.drawTexturedModalRect(x + 86, y + 6, 30, 183, (int)progress, 10);
		
		//Klein start bar progress. Max is 30.
		progress = tile.getKleinEmcScaled(30);
		this.drawTexturedModalRect(x + 133, y + 68, 0, 183, (int)progress, 10);
				
		//Burn Slot bar progress. Max is 30.
		progress = tile.getRawEmcScaled(30);
		drawTexturedModalRect(x + 81, y + 68, 0, 183, (int)progress, 10);
	}
}
