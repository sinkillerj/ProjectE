...
public class PhilStoneSmeltingHelper implements IResourceManagerReloadListener {
	...
	public PhilStoneSmeltingHelper(DataPackRegistries dataPackRegistries) {
	...
	public void onResourceManagerReload(@Nonnull IResourceManager resourceManager) {
		...
		RecipeManager manager = dataPackRegistries.getRecipeManager();
