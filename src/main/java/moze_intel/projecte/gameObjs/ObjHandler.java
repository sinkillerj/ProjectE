...
import moze_intel.projecte.gameObjs.items.armor.*;
...
public class ObjHandler
{
	...
	public static void addRecipes()
	{
		...
		//TransmutationTablet
		GameRegistry.addRecipe(new ItemStack(transmutationTablet), new Object[]{"DSD", "STS", "DSD", 'D', new ItemStack(matterBlock, 1, 0), 'S', Blocks.stone, 'T', transmuteStone});
