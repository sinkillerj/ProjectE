...
public class ObjHandler
{
	...
	public static final Item dmHelmet = new DMArmor(EnumArmorType.HEAD);
	public static final Item dmChest = new DMArmor(EnumArmorType.CHEST);
	public static final Item dmLegs = new DMArmor(EnumArmorType.LEGS);
	public static final Item dmFeet = new DMArmor(EnumArmorType.FEET);

	public static final Item rmHelmet = new RMArmor(EnumArmorType.HEAD);
	public static final Item rmChest = new RMArmor(EnumArmorType.CHEST);
	public static final Item rmLegs = new RMArmor(EnumArmorType.LEGS);
	public static final Item rmFeet = new RMArmor(EnumArmorType.FEET);
	...
	public static final Item dRod1 = new DiviningRodLow();
	public static final Item dRod2 = new DiviningRodMedium();
	public static final Item dRod3 = new DiviningRodHigh();
