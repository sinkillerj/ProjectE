...
public class ObjHandler {
	...
	public static final Block dmFurnace = new MatterFurnace(Block.Properties.create(Material.ROCK).hardnessAndResistance(1_000_000, 3_000_000).lightValue(14), EnumMatterType.DARK_MATTER).setRegistryName(PECore.MODID, "dm_furnace");
	public static final Block rmFurnace = new MatterFurnace(Block.Properties.create(Material.ROCK).hardnessAndResistance(2_000_000, 6_000_000).lightValue(14), EnumMatterType.RED_MATTER).setRegistryName(PECore.MODID, "rm_furnace");
	public static final Block dmPedestal = new Pedestal(Block.Properties.create(Material.ROCK).hardnessAndResistance(1, 3).lightValue(12)).setRegistryName(PECore.MODID, "dm_pedestal");
