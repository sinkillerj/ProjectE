...
public class ObjHandler {
	...
	public static final Block alchChest = new AlchemicalChest(Block.Properties.create(Material.ROCK).hardnessAndResistance(10, 3_600_000)).setRegistryName(PECore.MODID, "alchemical_chest");
	public static final Block interdictionTorch = new InterdictionTorch(Block.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().hardnessAndResistance(0).setLightLevel(state -> 14).tickRandomly()).setRegistryName(PECore.MODID, "interdiction_torch");
	public static final Block interdictionTorchWall = new InterdictionTorchWall(Block.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().hardnessAndResistance(0).setLightLevel(state -> 14).tickRandomly().lootFrom(interdictionTorch)).setRegistryName(PECore.MODID, "wall_interdiction_torch");
	public static final Block transmuteStone = new TransmutationStone(Block.Properties.create(Material.ROCK).hardnessAndResistance(10, 30)).setRegistryName(PECore.MODID, "transmutation_table");
	public static final Block condenser = new Condenser(Block.Properties.create(Material.ROCK).hardnessAndResistance(10, 3_600_000)).setRegistryName(PECore.MODID, "condenser_mk1");
	public static final Block condenserMk2 = new CondenserMK2(Block.Properties.create(Material.ROCK).hardnessAndResistance(10, 3_600_000)).setRegistryName(PECore.MODID, "condenser_mk2");
	public static final Block dmFurnace = new MatterFurnace(Block.Properties.create(Material.ROCK).hardnessAndResistance(1_000_000, 3_000_000).setLightLevel(state -> 14), EnumMatterType.DARK_MATTER).setRegistryName(PECore.MODID, "dm_furnace");
	public static final Block rmFurnace = new MatterFurnace(Block.Properties.create(Material.ROCK).hardnessAndResistance(2_000_000, 6_000_000).setLightLevel(state -> 14), EnumMatterType.RED_MATTER).setRegistryName(PECore.MODID, "rm_furnace");
	public static final Block dmPedestal = new Pedestal(Block.Properties.create(Material.ROCK).hardnessAndResistance(1, 3).setLightLevel(state -> 12)).setRegistryName(PECore.MODID, "dm_pedestal");
	public static final Block dmBlock = new MatterBlock(Block.Properties.create(Material.IRON).hardnessAndResistance(1_000_000, 3_000_000), EnumMatterType.DARK_MATTER).setRegistryName(PECore.MODID, "dark_matter_block");
	public static final Block rmBlock = new MatterBlock(Block.Properties.create(Material.IRON).hardnessAndResistance(2_000_000, 6_000_000), EnumMatterType.RED_MATTER).setRegistryName(PECore.MODID, "red_matter_block");
	...
	public static final Block collectorMK1 = new Collector(EnumCollectorTier.MK1, Block.Properties.create(Material.GLASS).hardnessAndResistance(0.3F, 0.9F).setLightLevel(state -> 7)).setRegistryName(PECore.MODID, "collector_mk1");
	public static final Block collectorMK2 = new Collector(EnumCollectorTier.MK2, Block.Properties.create(Material.GLASS).hardnessAndResistance(0.3F, 0.9F).setLightLevel(state -> 11)).setRegistryName(PECore.MODID, "collector_mk2");
	public static final Block collectorMK3 = new Collector(EnumCollectorTier.MK3, Block.Properties.create(Material.GLASS).hardnessAndResistance(0.3F, 0.9F).setLightLevel(state -> 15)).setRegistryName(PECore.MODID, "collector_mk3");
	public static final Block relay = new Relay(EnumRelayTier.MK1, Block.Properties.create(Material.ROCK).hardnessAndResistance(10, 30).setLightLevel(state -> 7)).setRegistryName(PECore.MODID, "relay_mk1");
	public static final Block relayMK2 = new Relay(EnumRelayTier.MK2, Block.Properties.create(Material.ROCK).hardnessAndResistance(10, 30).setLightLevel(state -> 11)).setRegistryName(PECore.MODID, "relay_mk2");
	public static final Block relayMK3 = new Relay(EnumRelayTier.MK3, Block.Properties.create(Material.ROCK).hardnessAndResistance(10, 30).setLightLevel(state -> 15)).setRegistryName(PECore.MODID, "relay_mk3");
