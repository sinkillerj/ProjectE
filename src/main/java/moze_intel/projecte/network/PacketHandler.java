...
public final class PacketHandler
{
	...
	public static void register()
	{
		...
		HANDLER.registerMessage(TransmutationSyncPKT.Handler.class, TransmutationSyncPKT.class, 6, Side.CLIENT);
		...
		HANDLER.registerMessage(RequestTransmutationPKT.Handler.class, RequestTransmutationPKT.class, 13, Side.SERVER);
