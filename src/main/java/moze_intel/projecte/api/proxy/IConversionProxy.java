...
public interface IConversionProxy
{
	 ...
	 * <ul>
	 *     <li>{@link ItemStack} -The ItemId, Metadata, and NBT data data will be used to identify this ItemStack (May contain a {@code Block} or {@code Item}). You can use {@link net.minecraftforge.oredict.OreDictionary#WILDCARD_VALUE} as metadata. If you don't want NBT data to be compared, set it to null.</li>
