...
public class APICustomEMCMapper implements IEMCMapper<NormalizedSimpleStack, Integer> {
	...
	final Map<String, Map<String, Integer>> customEMCforMod = Maps.newHashMap();
	...
	public void addMappings(IMappingCollector<NormalizedSimpleStack, Integer> mapper, Configuration config) {
		...
		for (Map.Entry<String, Map<String, Integer>> e : customEMCforMod.entrySet()) {
			if (e.getKey() == null) continue;
			priorityMap.put(e.getKey(), config.getInt(e.getKey() + "priority", "customEMCPriorities", PRIORITY_DEFAULT_VALUE, PRIORITY_MIN_VALUE, PRIORITY_MAX_VALUE, "Priority for Mod with ModId = " + e.getKey() + ". Values: " + e.getValue().size()));
		}
