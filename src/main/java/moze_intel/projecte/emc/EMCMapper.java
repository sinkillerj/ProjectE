...
public final class EMCMapper 
{
	...
	public static void map()
	{
		...
		IValueGenerator<NormalizedSimpleStack, Integer, IValueArithmetic<Fraction>> graphMapper = new FractionToIntegerTranslator<NormalizedSimpleStack, IValueArithmetic<Fraction>>(new SimpleGraphMapper<NormalizedSimpleStack, Fraction, IValueArithmetic<Fraction>>(new HiddenFractionArithmetic()));
