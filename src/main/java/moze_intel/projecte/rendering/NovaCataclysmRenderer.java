...
public class NovaCataclysmRenderer extends Render
{
	...
	public void doRender(EntityNovaCataclysmPrimed entity, double x, double y, double z, float par8, float par9)
	{
		...
		blockrendererdispatcher.func_175016_a(Blocks.tnt.getDefaultState(), entity.getBrightness(par9));
		...
		if (entity.fuse / 5 % 2 == 0)
		{
			...
			blockrendererdispatcher.func_175016_a(ObjHandler.novaCataclysm.getDefaultState(), 1.0F);
