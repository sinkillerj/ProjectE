package sinkillerj.projecte.gameObjs.gui;

import sinkillerj.projecte.PECore;
import sinkillerj.projecte.gameObjs.container.DMFurnaceContainer;
import sinkillerj.projecte.gameObjs.tiles.DMFurnaceTile;
...
public class GUIDMFurnace extends GuiContainer
{
	...
	{
		this.fontRendererObj.drawString("DM Furnace", 57, 5, 4210752);
		this.fontRendererObj.drawString("Inventory", 57, ySize - 96 + 2, 4210752);
	}
}
